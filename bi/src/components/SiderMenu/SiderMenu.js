...
export default class SiderMenu extends PureComponent {
  ...
  */
  ...
  render() {
    ...
    const paddingLeft = collapsed? { paddingLeft: '30px'}: null;
    return (
      <Sider
        trigger={null}
        collapsible
      ...
      >
        <div className={styles.logo} key="logo" style={paddingLeft}>
          <img src="https://images.51rz.com/images/icon/logo-menu.png"  alt="logo" />
          <h1>人众金服数据分析后台</h1>
        </div>
        <Menu
          key="Menu"

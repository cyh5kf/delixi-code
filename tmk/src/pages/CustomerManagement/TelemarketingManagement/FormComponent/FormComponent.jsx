        ...
        <form action="">
          <Grid container spacing={24}>
            ...
            <Grid item xs={6} sm={3}>
              <FormControl className="fix_select">
                <Button
                  onClick={() => AssignCustomerService.open({user_ids:selected,queryMethod:'custom/normal','commandMethod':'allot/normal'})}
                  variant="raised"
                  color="primary"
                  className=""
                >
            ...
            <Grid item xs={6} sm={3}>
              <FormControl className="fix_select">
                <Button onClick={this.props.resetForm} variant="raised" color="primary" className="">
                  重置
                </Button>
              </FormControl>
            </Grid>

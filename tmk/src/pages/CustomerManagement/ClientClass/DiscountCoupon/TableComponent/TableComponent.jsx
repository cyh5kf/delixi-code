...
class TableComponent extends React.Component {
  ...
  render() {
    ...
    const columnData = [
      ...
      { id: "couponMoney", numeric: true, disablePadding: false, label: "优惠券面值" },
      { id: "couponType", numeric: true, disablePadding: false, label: "优惠券类型" },
      { id: "couponName", numeric: true, disablePadding: false, label: "优惠券名字" },
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell
                      ...
                      numeric
                    >
                      {n.couponType==1?'现金红包':n.couponType==2?'虚拟红包':n.couponType==9?'加息劵':'无'}
                    </TableCell>
                    <TableCell
                      padding="none"
                      className={classes.tableCell}

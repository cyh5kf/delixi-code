        ...
        return (
            <div >
                ...
                <div className={Css.msgCont}>
                    ...
                    {/*<div className={Css.left}>*/}
                        {/*<h4>可提现金额 <span>(元)</span></h4>*/}
                        {/*<h5>{withDrawalAmountTxt}</h5>*/}
                    {/*</div>*/}
                    {/*<div className={Css.left}>*/}
                        {/*<h4>待入账金额 <span>(元)</span></h4>*/}
                        {/*<h5>{capitalAmountTxt}</h5>*/}
                    {/*</div>*/}
                    <div className={Css.left}>
                        <h4>提现处理中 <span>(元)</span></h4>
                        <h5>{dealCashAmount.toFixed(2).toLocaleString()}</h5>
                    </div>
                </div>

...
class New extends Component {
    ...
    render() {
        const list = [
            {
                question: '人众金服是做什么的网站？',
                answer: '浙江人众金融服务股份有限公司（以下简称“人众金服”）成立于2013年4月，是浙江最早创立的互联网金融企业之一，2017年1月获立元创投5000万人民币A轮投资。平台已于2016年获批ICP许可证，同年12月，通过国家公安部监制信息安全等级保护三级安全备案；2017年4月完成与存管银行的资金存管对接，成为行业全面合规的网贷平台之一。\n人众金服精准定位产业互联网金融，深耕供应链金融及消费金融领域，构筑互联网金融与企业、商品（服务）供应链、消费等互利共存、持续发展的良好产业生态。致力为用户提供更加优质、高效、安全的网络借贷信息中介服务。'
            },
            {
                question: '我在人众金服上投资安全吗？',
                answer: '人众金服由银行进行资金存管，投资人资金与平台有效隔离，保证安全；平台安全运营5年，同时平台严格甄选顶级合作企业，构筑八重安全保障，保障投资人资金安全。'
            },
            {
                question: '人众金服网站靠什么盈利？',
                answer: '我们的盈利模式是：如果借款企业在人众金服的平台上发布借款的信息，是需要向人众金服支付信息服务费的。每一笔企业借款，人众金服平台会向借款企业收取一定的信息服务费。此外，还有其他平台在人众金服进行商业合作和广告投放的服务费。'
            },
            {
            ...
            {
                question: '人众金服自身的运营变动是否会影响用户的投资？',
                answer: '请用户放心，人众金服的任何变动都不会影响投资者与借款企业间的借贷关系及借款协议的执行。借款企业有义务继续按照借款协议的约定，按时偿还投资人的借款本金和利息。此外，借款协议中的承担实际担保义务的第三方机构，仍须按协议履行应尽的担保责任。否则投资人有权依据借款合同的约定采取必要的法律手段追究借款企业及相关机构的法律责任。'
            }
        ];
                    ...
                    <ul>
                        <li>
                            <NavLink exact to="/login">
                                <p>1. 注册</p>
                                <img src="https://images.51rz.com/images/rebuild/pc/img/step1.png" alt=""/>
                            </NavLink>
                        </li>
                        ...
                        <li>
                            <NavLink exact to="/binging">
                                <p>2. 安全认证</p>
                                <img src="https://images.51rz.com/images/rebuild/pc/img/step2.png" alt=""/>
                            </NavLink>
                        </li>
                        <div className="step"></div>
                        <li>
                            <NavLink exact to="/recharge">
                                <p>3. 充值</p>
                                <img src="https://images.51rz.com/images/rebuild/pc/img/step3.png" alt=""/>
                            </NavLink>
                        </li>
                        <div className="step"></div>
                        <li>
                            <NavLink exact to="invest">
                                <p>4. 投资</p>
                                <img src="https://images.51rz.com/images/rebuild/pc/img/step4.png" alt=""/>
                            </NavLink>
                        </li>
                        <div className="step"></div>
                        <li>
                            <a href="javascript:void(0)">
                                <p>5. 坐收利息</p>
                                <img src="https://images.51rz.com/images/rebuild/pc/img/step5.png" alt=""/>
                            </a>
                        </li>
                    </ul>
                </div>
...
class Register extends Component {
    ...
    render() {
        const register = [
            {
                question: '如何成为人众金服的注册用户？',
                answer: '1、网页端：打开人众金服官网，点击网页右上角【注册】，填写相关信息，即可注册成功。\n2、APP端：打开人众金服账户，点击【我的】-【立即登录】-【免费注册】进入注册页面填写相关信息，即可注册成功。\n注：18周岁以下用户不能注册。 '
            },
            {
            ...
            },
            {
                ...
                answer: `邀请码为非必填项。人众金服注册成功的用户都拥有唯一性的邀请码。新用户接受邀请在注册时填写邀请码，可绑定与邀请人形成绑定关系，双方均可获得一定奖励，具体参照平台活动及公告。`
            },
            {
                question:'注册人众金服账户一定要用银行的预留手机号码吗？',
                answer:`注册时的手机号码可以不是银行预留手机号，但是在开通银行存管账户的时候，必须填写银行预留手机号。`
            }
        ];
        const login = [
            {
            ...
            {
                question: '为什么要设置交易密码?',
                answer: '在开通银行存管账户时，会要求投资人设置交易密码，此密码将做为投资人充值、投资、提现等操作时的交易密码。'
            },
            {
                question: '登录密码忘记了如何找回？',
                answer: '1、网页端：进入人众金服官网首页点击【登录】-【忘了密码】填写手机号码和验证码，点击获取验证码，然后填写新密码即可修改成功。\n2、APP端：进入人众金服APP点击【登录】-【忘记密码】获取验证码并设置新密码。'
            },
            {
                question: '注册手机号码可以更换吗？',
                answer: '可以更换，登录您的人众金服账户，点击【我的账户】-【安全中心】通过旧手机号码输入验证码进行修改；'
            },
        ];
...
class Binging extends Component {
    ...
    render() {
        const register = [
            ...
            {
                question: '实名认证不了怎么办？',
                answer: `人众金服的实名认证是与公安系统联网的，若您提供的信息不一致，就会导致无法通过。以下几种情况，将无法自行完成实名认证：\n1.名字中带有生僻字\n2.曾经改过名字\n3.军人转业、复员换的身份证\n4.户籍有办过迁移\n5.身份证号码中的字母没有大写`
            },
            {
                question: '手机、身份证认证之后是否可以再次认证一个账号？',
                answer: `人众金服的身份证认证系统是和公安机关联网的，系统会自动认证。身份证、手机号码、都只能认证一个人众金服账户，不能重复认证。身份证一旦认证成功不得修改。`
            },
            {
                question: '如何修改实名认证信息？',
        ...
        const login = [
            {
                ...
                answer: '您在人众金服注册开通银行存管进行四要素认证、在平台进行提现或快捷充值操作，需绑定银行卡。'
            },
            {
                question: '开通存管账户时，是否需要办一张存管银行卡？',
                answer: '不需要。用户开通存管账户是指开通了一个银行的存管电子账户，没有实体的银行卡。用户登录人众金服个人账户，按照提示步骤进行操作，即可完成开通，不需要去线下网点进行开通。'
            },
            {
                question: '可以绑定哪些银行卡？',
                answer: '请参照充值页面。'
            },
            {
                ...
                answer: '人众金服已实现银行资金存管，注册完成后须开通银行存管进行四要素信息认证，其中就直接绑定了银行卡，需要注意的是银行卡的预留手机号必须与注册手机号一致。'
            },
            {
                question: '无法绑定银行卡怎么办？',
    ...
    render() {
        const register = [
            ...
            },
            {
                ...
                answer: `人众金服不支持信用卡充值，禁止信用卡套现、虚假交易等行为,一经发现将予以处罚,包括但不限于：限制收款、冻结账户、永久停止服务。请各位投资者选择自己的储蓄卡绑定。`
            },
            {
        ...
        const login = [
            ...
            {
                question: '如何提现？',
                answer: '在人众金服【我的账户】中选择提现，按页面提示操作即可，每次提现金额不小于100元。'
            },
            {
                question:'为什么提现申请会失败？',
            ...
            {
                question: '提现什么时候可以到账？',
                answer: '当日21：00前申请提现当日到账，21:00之后申请提现延迟至次日到账，不区分双休及节假日。（实际到账时间需根据提现银行的处理机制而定）。',
            ...
            },
            {
                ...
                tips:'为更大程度地维护您的收益，人众金服在PC端、app端和wap端共提供每月前3次免除提现手续费的福利。'
            },
            {
            ...
            },
            {
                ...
                answer: '您申请提现后，申请即时通过，提现需求会提交到存管银行受理，实际到账时间需根据提现银行的处理机制而定。用户当日21：00前申请提现当日到账，21:00之后申请提现延迟至次日9:00之后到账，不区分双休及节假日。'
            },
            {
                question: '银行卡无法提现怎么办？',
                answer: '由于银行对互联网借贷业务的限制，仅支持使用普通借记卡进行交易。如果您已使用高端卡进行充值，遇到无法提现的问题，请联系人众金服客服 400-655-8858，提供线下资料进行审核，进行人工变更银行卡。目前市场上常见的高端卡种类有：财富卡、理财卡、医保卡、联名卡、金卡、银卡、钻石卡以及高端客户私人银行卡等。'
            },
            {
                question: '绑定银行卡（非快捷充值银行卡）可以修改么？',
                answer: '为保障账户资金安全，绑定银行卡都不能自行修改。如需修改，请联系人众金服客服 400-655-8858，我们将通过线上快速申请与线下人工审核相结合的方式为您更换绑定的银行卡。'
            },
            {
                question: '提现后能否取消？',
                answer: '提现一旦提交无法撤销。 您可以在【我的账户】-“资金明细”页面的“提现记录”中查看。人众金服提醒您根据自身需求安排好资金使用计划，您的提现需求我们会第一时间处理的。'
            }
        ];
        const lis1=register.map((v,i)=>{
            return (
...
class Invest extends Component {
    ...
    render() {
        const register = [
            {
                question: '我可不可以投新手标？',
                answer: '新手标仅限人众金服新手用户“投资”1次。新手用户特指注册了人众金服账户，但没有进行过投资的用户。'
            },
            {
                question: '人众金服什么时候发标？如果没有标的了怎么办？',
            ...
            {
                question: '产品节假日是否产生收益？',
                answer: `确认成功购买的产品，在该产品到期日之前，所有节假日都将获得收益，但也不保证一定可以获得历史收益。`
            },
            {
                question: '什么时候开始计息？有哪些还本付息方式？',
                answer: `人众金服实行当天投资，满标当天生息的计息方法。\n还款方式根据项目种类不同，分为如下两种：\n1、按日计息，按月付息，到期还本：利息会在付息日当天到达您的人众金服账户，本金是在到期当天。\n2、按日计息，到期归还本息：到期一次性本息全部归还。`
            },
            {
                question: '利息是如何计算的？',
                answer: `天标利息=历史年化收益率*投资金额*投资期限天数/365\n月标利息=历史年化收益率*投资金额*投资期限月数/12`
            },
            {
                question: '为什么会投资失败？',
            ...
            {
                question: '如何投资人众金服的产品？',
                answer: `登录人众金服平台后选择产品，输入投资金额，输入交易密码，点击“立即投资”，即可完成投资。如有红包及加息券，则在输入密码前选择优惠券即可。`
            },
            {
                question: 'R计划是什么产品？',
            ...
            },
            {
                ...
                answer: `别急，您可以通过债券转让的形式，转让您投资的产品。进入“我的账户”点击“我的投资”，在回款列表中选择你想转让的标的点击“转让”即可进行操作。（需要注意的是债权转让只能转让持有满30天以上的标的。）`
            },
            {
                question: '到期后如何收回投资本金和利息？收到还款后能马上再投资吗？',
                answer: `投资项目的本息到期后，人众金服会直接将本息自动转入到账户余额，您可以选择提现或者再投资。我们建议投资人在收到还款后进行再次投资，确保您收益的最大化。`
            },
            {
                question: '资产总额如何计算？',
        ...
        const login = [
            {
                ...
                answer:`1、众供宝有效投资满30天（满标日起算含30天）且产品页面有可债权转让标识的支持债权转让；众消宝产品、R计划产品不支持债权转让。\n2、债权转让人在债权转让发起之日前的本金所产生的利息归债权转让人所有，债权转让发起之日后（含发起转让当日）的债权本金所产生的利息归承接人所有。\n3、承接标不能进行二次转让。\n4、用户自主发起的转让，48小时后转让没成交则自动失效，可重新发起转让。\n5、 当前标转让期间回款，转让自动失效，可转让的资产到期日前三天，不支持转让。\n6、 转让费用说明：\n　　a.转让标会有相应的折价，转让金额由转让人自行设定，但不得低于本金的95%（折价金额不得高于本金5%），不得高于本金及债权转让发起之日前的本金所产生的利息之和。\n　　b.转让若有折价金额归承接人所有。若转让金额包括利息，转让时由承接人先垫付给转让人该部分利息，该垫付的利息不计息，转让人原订单的本金与实际承接的差额将在项目到期后返还。\n7、转让服务费用说明：发起债权转让的转让人按照以下规则承担转让服务费。转让服务费=转让本金*转让服务费率，转让的服务费率为0.8%。\n8、债权转让规则最终解释权归人众金服所有。`
            },
            {
            ...
            },
            {
                ...
                answer: '如果该笔债权转让成功，则资金将在成功时转入您在人众金服平台账户中。'
            },
            {
                question: '债权转让需要手续费吗？',
                answer: ` a.发起债权转让的转让人按照以下规则承担转让服务费。转让服务费=转让本金*转让服务费率，转让的服务费率为0.8%。服务费由平台收取。\n b.转让标会有相应的折价，转让金额由转让人自行设定，但不得低于本金的95%（折价金额不得高于本金5%），转让折价费归承接人所有`,
            },
            {
                question: '为何转让债权可以自己定价？',
                answer: '已投资人众金服优质项目的投资人，在项目尚未到期并且急需资金时，可以通过将已有债权转让，来达到资金回笼的目的，转让方可根据需要定价处理。'
            },
            {
                question: '被转让的债权如何计息？',
...
class Redpack extends Component {
    ...
    render() {
        const register = [
            ...
            {
                question: '如何获得红包或加息券？',
                answer: '红包的获取方式有如下几种：\n1.成功注册：系统会自动给您的人众金服账户发送150元红包奖励；\n2.前四次投资中，每完成一次投资均可以获得一个红包或加息券；\n3.参加活动：积极参加人众金服的各类活动均有可能获得红包或加息券；\n4.为感谢投资人对人众金服信赖与支持，平台会在您生日当天（以身份证信息为准）赠送100元生日红包至您的账户。生日红包自发放之日起有效期30天，使用条件：①投资满15000元可使用；②限投3月以上标的；③新手标、债权转让标除外。'
            },
            {
                question: '红包或加息券使用规则',
                answer: <span><b>A、红包使用规则：</b><br/>1、每个红包都有不同的使用条件和使用期限，如在期限内未使用，过期则失效；<br/>2、红包不可用于投资抵扣，以返现的方式发放到帐户；
例：您在上午9点时投资标的（众供宝—2903）1000元，使用10元红包，投资成功后，10元红包以返现的形式发放到您的帐户中，您可以到我的账户进行查看。<br/>3、每次投资只能使用一张红包。如果您有多张红包，可以分多次投资使用；<br/>4、红包不能用于新手标和债权转让；<br/>5、红包使用规则最终解释权在法律范围内归人众金服所有。<br/><b>B、加息券使用规则： </b><br/>1、每个加息券都有不同的使用条件和使用有效期，在期限内未使用，则过期作废。<br/>2、加息券产生的利息，在投资项目到期后，自动返还到个人账户。<br/>3、一次投资只能使用一张加息券，且不可与其他加息券同时使用。<br/>4、加息券不能用于新手体验标和债权转让。<br/>5、加息券使用规则最终解释权在法律范围内归人众金服所有。</span>
            },
            {
            ...
            {
                question: '特别说明',
                answer: `以上规则自2015年12月1日起执行，所有最终解释权在法律范围内归人众金服所有。\n浙江人众金融服务股份有限公司`
            },
        ];
        const lis1=register.map((v,i)=>{
            return (

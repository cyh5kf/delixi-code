...
export default class RewardRulesDialog extends React.Component {
    ...
    handleOk = () => {
        ...
        let { rewardOutArray, rewardFormIndex, rewardOptionsData, rewardRuleType } = store;
    ...
    render() {
        const { store, actions } = this.props;
        const { rewardOptionsData, fetching, rewardRuleType, rewardFormIndex, rewardOutArray } = store;
        const { selectValue } = this.state;
        let title = '';

<template>
    <div class="xysBox">
        <div class="xysTop">
            <h1>个人投资与服务协议</h1>
            <div class="xysJia"><span>甲方：</span><span id="jiafang" v-text="obj.tenderName"></span></div>
            <div class="xysJia"><span>平台用户名：</span><span id="pingtai" v-text="obj.rzTenderName"></span></div>
            <div class="xysJia"><span>乙方：浙江人众金融服务股份有限公司</span></div>
            <div class="xysJia" style="position:relative"><span>注册地址 ：杭州市西湖区学院路<b>28-38</b>号<b>1</b>幢<b>1</b>号楼<b>2501</b>室</span>
                <img src="https://images.51rz.com/images/rebuild/wx/img/renzhong.png" style="position:absolute;left:0.77rem;top:-0.34rem;width:2rem"/></div>
            <div class="xysJia"><span>根据《中华人民共和国合同法》及相关法律法规的规定，双方遵循平等、自愿、互利和诚实信用的原则友好协商，就甲方投资、乙方为甲方提供投资服务达成一致，以兹信守。</span>
            </div>
        </div>
        <div class="xysCen">
            <h2>第一条 释义 </h2>
            ...
            <h2>第八条 资金投资及回款方式</h2>
            <p>
                <b>8.1</b> 投资金额： <span id="daxie" v-text="obj.tenderAmountStr"></span>（大写） ；
                年化收益率为<span id="lilv" v-text="obj.borrowApr+'%'"></span>；
                投资期限为 <span id="month" v-text="obj.borrowPeriodName"></span> ，
                自 <span v-text="obj.borrowTenderStr"></span>止<br/>
        ...
        <div class="xysBott" style="position:relative;padding-bottom:200px">
        <img src="https://images.51rz.com/images/rebuild/wx/img/renzhong.png" style="position:absolute;left:0.8rem;top:-0.5rem;width:2rem"/>
        <span>甲方：</span><span id="jiafang2" v-text="obj.tenderName"></span>
        <br/>
        乙方： 浙江人众金融服务股份有限公司
    </div>
    </div>
...
<style lang="scss" scoped>
    ...
    h1, h2, h3, h4, h5, h6, input, li, p, a, sapn {
        font-size: 100%;
        font-weight: normal;
        font-family: "微软雅黑";
    }

    ...
    <div class="container">
        <div class="content">
            ...
            <section class="section2">
                <div class="title"><img src="https://images.51rz.com/images/rebuild/wx/img/welfare-title2_01.png" alt=""></div>
                <ul>
                    <li>新手标</li>
            ...
            <section class="section4">
                <div class="title">
                    <img src="https://images.51rz.com/images/rebuild/wx/img/welfare-title4.png" alt="">
                </div>
                <p>1、新手标为新手用户专属特权，每位用户最多仅可投资1次
                    新手标；<br/>2、红包不可用于投资抵扣，以返现的方式发放到帐户；<br/>3、红包不可累计使用，每单笔投资最多可使用一张；<br/>4、投资红包均设有有效期限，过期则失效；<br/>5、红包不能用于新手标和债权转让标；<br/>6、本活动最终解释权在法律范围内归杭州果投所有。</p>
            </section>
        </div>
    </div>
</template>
...
<style lang="scss" scoped>
    ...
    .banner {
        ...
        background: url('https://images.51rz.com/images/rebuild/wx/img/welfare_banner_02.png') center/cover no-repeat;
